...
extern template void reduce_wrapper<bin_ops::add,T>(T const * data, T * res, int N); \
extern template void reduce_wrapper<bin_ops::greater_of,T>(T const * data, T * res, int N); \
